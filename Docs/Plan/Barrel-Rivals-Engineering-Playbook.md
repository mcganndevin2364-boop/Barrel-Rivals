...
**September 21 isolated Unity horse/saddle increment (S10/S12/S13/S23/S43).** The [development benchmark](../Art/Reins-Horse-Unity-Benchmark.md) connects the replacement rig, explicit materials, fitted saddle and support camera under actual Unity lighting. It is excluded from player scenes. Neutral surface/color checks and one focused live Play Mode test pass; seven-pose animated source fidelity misses its retained 0.2 mm target at 0.364 mm and remains open. Bridle/rider/gait/LOD fitting and runtime adoption remain future work. No whole section, photographic or phone gate is accepted.

**September 21 candidate rider/tack increment (S10/S12/S13/S23/S43).** The [fitting checkpoint](../Art/Reins-Horse-Rider-Fit.md) connects the existing rider/gloves, measured headstall/boot targets and private flexible reins to the development horse. Seven focused live/legacy regressions pass; 84 walk/pull poses retain endpoint/contact alignment. Current cost is 92,402 triangles/25 slots, with remaining natural gaits/actions, LODs, source-motion precision and runtime/device/reference gates open. The stable still is a neutral unsaved inspection, not an inventory replacement. Full section requirements remain in force.

**September 21 candidate locomotion increment (S10/S12/S23).** The [new gait checkpoint](../Art/Reins-Horse-Locomotion-Study.md) adds four authored actions, a five-way speed blend and connected rider lean. Flat-floor correction addresses measured blend penetration without moving Core/actor state. Actual motion review fixed stale skin matrices in same-frame captures and clothing/camera clipping. Original Walk/source and historical evidence remain preserved. This is still an isolated scene; natural turn/brake/Wrap, world planting, visual/material budgets and phone acceptance remain required.

**September 21 coat/hat increment (S10/S13/S23/S43).** The [character finish checkpoint](../Art/Reins-Character-Finish-Checkpoint.md) adds skinned anatomical coat tangents and directional opaque lighting to the development horse, plus an original head-bound western hat in the saved racing scene. No catalog slot or competitive upgrade is added. Preserve imported channels, actual-light pixel tests and head/bodycam/ghost behavior. R2, character budgets, natural movement and phone qualification remain open.

**September 21 saved showroom increment (S10/S13/S43/S50).** The [showcase checkpoint](../Art/Reins-Stable-Showcase-Checkpoint.md) connects the existing idle rig to stowed reins, preserves cosmetic bindings/private mesh lifetime, frames the real horse within the UI and corrects tack-view visibility. Actual saved-scene views and focused regressions are separate from the previous candidate studies. No card, photographic quality or device gate is completed.


**September 21 shared glove construction increment (S13/S23/S43/S50).** The [tailoring checkpoint](../Art/Reins-Glove-Tailoring-Checkpoint.md) integrates original sewn panels/cuff/thread into saved racing and inspection meshes, preserving six dyes and one material per glove. The existing anatomical shell and palm-side rein aperture remain unchanged. Actual-render checks distinguish dyed leather from fixed thread; item capture initializes URP before its first product frame. Cost increases to 83,442 race triangles / 26 slots, so LOD/material and native/device gates remain open. This is no new progression/ownership, photographic acceptance or full-section completion.

**September 21 continuous mane increment (S10/S12/S13/S23/S43).** The [foundation checkpoint](../Art/Reins-Mane-Foundation-Checkpoint.md) replaces the dense overlapping base with one fitted surface and retains swept outer locks, original atlas/forelock/tail data and private ghost coverage. Actual saved race/stable/equip/camera behavior and moving fit are checked without changing controls or authority. The current character is 83,634 triangles / 26 slots, above budget. No full section, photographic or device acceptance is claimed.

**September 21 worked footing increment (S18/S24).** The [surface checkpoint](../Art/Reins-Worked-Footing-Checkpoint.md) integrates original offline slopes/height/wear, consistent world-space photograph/normal blending, broad drag arcs and type-driven wetness. Seven existing meshes and all reviewed photo sources remain exact; no contacts or Core rules change. Actual directional/seam/profile, canonical replay and stable/gear checks pass. Natural loose dirt/dust, native shader costs and device/reference acceptance remain pending; no complete section is claimed.

**September 21 full-course candidate integration (S10/S12/S13/S23/S43).** The [integration review](../Art/Reins-Horse-Race-Integration.md) now runs the explicit new horse through the actual course/controller, saved 20-style gear, reduced-motion camera and independent ghost. Nine focused tests pass; all five gait clips and the unchanged 33.86-second result appear in continuous actual Unity evidence. The active barrel can leave the forward camera during tight turns. The candidate remains outside player scenes; natural actions, coat/hair/clothing detail, source-fidelity target, rendering budgets/LODs, showroom adoption and phone qualification remain open. All card requirements remain unchanged.

**September 21 candidate stable integration (S05/S10/S13/S43/S50).** The [matching review](../Art/Reins-Horse-Stable-Integration.md) carries the explicit horse into a saved animated showroom with fitted resting reins, actual equipment thumbnails and editor-only round-trip navigation. Nine focused checks preserve equip/reload/cancel, full-course rules and production flow. It remains one horse/twenty local styles with no progression or authority writes. Horse-only cost is 65,288 triangles/17 slots; visual, natural-action, source-fidelity, LOD/device and all original card gates remain open.

**September 21 rider turn view (S23/S50).** The [camera checkpoint](../Art/Reins-Rider-Turn-View.md) uses the existing course solely for a bounded view-only glance and close-barrel pitch, with direct horse yaw, fixed HUD controls and reduced-motion information preserved. Nine focused tests include all677active-turn samples in both modes/aspects and the unchanged canonical result. This fixes the measured replay visibility gap; arbitrary-route occlusion, natural rider movement and phone comfort remain open, as do every original section requirement.
