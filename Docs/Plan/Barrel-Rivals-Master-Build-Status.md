...
**Next concrete work.** Review the actual moving alley and current stable/gear captures in [the latest art checkpoint](../Art/Reins-Glove-Anatomy-Checkpoint.md); the [v2 checkpoint](Reins-v2-Alley-Checkpoint.md) owns gameplay acceptance. Build a fresh 0.5 development artifact so the changed view and gear can be reviewed on the phone while refining horse/rider/arena art. Measure actual timing, visual comfort, lifecycle behavior and sustained performance; natural planted turns/braking and full reference quality remain open. Preserve free/original asset provenance and historical evidence. Do not expand the roster before this quality gate. M1N follows R2 acceptance.
