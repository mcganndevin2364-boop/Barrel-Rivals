...
The [horse movement refinement](../Art/Reins-Horse-Motion-Refinement.md) updates the offline CC-BY candidate with connected-edge skin smoothing, a higher 28-frame walk, lower knee lift, measured toe roll and restrained body motion. The 225-sample FBX/ground-contact checks and portable rebuild pass; worst walk edge strain falls 3.011→2.317. A side/quarter/rider movie is recorded. This is still an untextured 39k-body candidate outside Unity Assets; eyes/coat, residual deformation, other gaits, attachments, LODs and actual Unity/device acceptance remain open. Next improve the face/eyes and coat while retaining motion checks, then fit hair/tack/rider and explicit presentation bone roles.
