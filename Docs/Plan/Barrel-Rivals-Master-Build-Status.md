...
| 10 | Horse Animation State Machine | 19-bone horse Idle/Walk/Gallop studies plus CC0-derived skinned rider with saddle/wrist/boot alignment and ghost integration tested; separate 39-bone replacement now animates in an isolated Unity horse/saddle benchmark; seven-pose source fidelity target remains open, with visual deformation unresolved; authored planted turns/braking/Wrap and device acceptance pending |
