...
| 10 | Horse Animation State Machine | 19-bone horse Idle/Walk/Gallop studies plus CC0-derived skinned rider with saddle/wrist/boot alignment and ghost integration tested; separate 34-bone replacement rig/walk study checked offline, with visual deformation unresolved; authored planted turns/braking/Wrap and device acceptance pending |
