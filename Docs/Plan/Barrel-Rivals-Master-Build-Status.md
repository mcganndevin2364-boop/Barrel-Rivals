...
| 10 | Horse Animation State Machine | 19-bone horse Idle/Walk/Gallop studies plus CC0-derived skinned rider with saddle/wrist/boot alignment and ghost integration tested; separate replacement rig/walk plus fitted groom checked offline (34 base + five hair bones), with visual deformation unresolved; authored planted turns/braking/Wrap and device acceptance pending |
