...
for view in ('quarter', 'rider'):
    ...
    label = seq.strips.new_effect('Groom study ' + view, type='TEXT', channel=2, frame_start=start, frame_end=start + 112)
    label.text = 'FITTED MANE / TAIL STUDY  |  ' + view.upper() + '\nOffline 3D render - not gameplay or final art'
    label.font_size = 19
...
s.render.filepath = str(folder / 'HeroHorse-GroomStudy.mp4')
