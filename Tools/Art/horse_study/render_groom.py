...
bpy.ops.render.render(write_still=True)
cam.location=(0,-.35,2.25);cd.type='PERSP';cd.lens=24;cam.rotation_euler=(Vector((0,4,1.9))-cam.location).to_track_quat('-Z','Y').to_euler()
scene.render.filepath=str(folder/'rider.png');bpy.ops.render.render(write_still=True)
print('GROOM_REVIEW_COMPLETE')
