...
Latest character source: [skinned hair and synchronized motion checkpoint](Docs/Art/Reins-Character-Motion-Checkpoint.md), with a real Unity motion study and fresh stable/race captures. This remains 0.4/v1 source; no new phone installation or finished-animation claim.
...
The current source imports the CC0 horse with original Idle/Walk/Gallop studies and replaces selected arena/HUD presentation. Modeled foreground gloves/bridle/reins now exist; a finished full rider, planted production gaits and reference-level visual/device acceptance remain pending. The older installed 0.4 artifact still contains its prior procedural art. No paid assets were purchased. [Current graphics checkpoint](Docs/Art/Reins-Premium-Graphics-Checkpoint.md) and [material provenance](Docs/Art/Reins-Premium-Materials-Provenance.md) record source hashes, licensing and limitations.
