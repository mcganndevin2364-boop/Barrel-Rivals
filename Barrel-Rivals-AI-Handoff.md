...
The current source refines **the horse’s cheek/flank contours and upper-body surface**, adds explicit four-weight skinning and a fitted western headstall, and replaces circular scenery bands with one irregular terrain mesh. It retains the rig, textures, original hair/saddle and connected MyStable/Tack/Rider Gear flow. Read [the surface checkpoint](Docs/Art/Reins-Surface-Fit-Checkpoint.md) for current tests, moving captures and limits. Photographic quality, a full rider, material/LOD optimization, phone qualification and the approved 0.5/v2 gameplay remain unfinished.
