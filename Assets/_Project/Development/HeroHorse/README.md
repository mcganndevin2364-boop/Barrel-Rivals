...
## Speed-driven gait study

The [locomotion checkpoint](../../../../Docs/Art/Reins-Horse-Locomotion-Study.md) owns the current five-gait blend, actual moving capture, flat-floor hoof correction and camera changes. In Play Mode adjust `HeroHorseLocomotion.targetSpeed` from0–14m/s. The four new FBXs contain a bind-reference mesh solely for import; the saved scene uses the existing full horse model. This scene remains excluded from player builds.
